...
func TestPostureScript_NamesOnlyRealDoctorRows(t *testing.T) {
	...
	for _, c := range []Check{GuestLocalhostCheck{}, BaseCurrencyCheck{}, BaseReleaseCheck{}, GuestSyncVerifyCheck{}, GuestDeliveryCheck{}, DaemonLoadsCheck{}, ServingDaemonVersionCheck{}, DaemonVMMCheck{}, HostDaemonsCheck{}, DuplicateDaemonsCheck{}} {
		known[c.Name()] = true
	}
